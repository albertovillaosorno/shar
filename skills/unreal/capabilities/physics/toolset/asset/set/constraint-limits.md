...
Use this tool to replace the complete angular motion and limit descriptor for
one constraint.
...
```json
{
  "info": {
    "bone1Name": "Bone02",
    "bone2Name": "Bone01",
    "swing1LimitDegrees": 25,
    "swing1Motion": "Limited",
    "swing2LimitDegrees": 15,
    "swing2Motion": "Locked",
    "twistLimitDegrees": 10,
    "twistMotion": "Limited"
  },
  "physicsAsset": {
...
`GetConstraints` returned exact Limited, Locked, and Limited motions with
angular limits `25`, `15`, and `10` degrees.
...
- Supply the complete constraint descriptor, including motion enums and limits
  even when a motion is Locked or Free.
...
Constraint descriptor. Bone1Name and Bone2Name identify the constraint.
