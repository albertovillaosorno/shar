...
Use this tool to add one physics body for a skeleton bone that currently has
no body.
...
`GetBodyNames` changed from only `Bone01` to `Bone01` and `Bone02`.
...
The name of the bone to add a body for.
