...
Returns property schema for a specific Renderer class. Describes all available
properties and their types for the given renderer type.
...
The renderer class to get the schema for (e.g.,
...
Schema describing all properties for the specified renderer class
