...
Use this tool to embed one reviewed PCG graph as a subgraph node in another
graph.
...
```json
{
  ...
  "jsonParams": "{}",
  "nodeComment": "Disposable subgraph",
  "nodeName": "Subgraph_c297c180",
  "nodeTitle": "MCP Subgraph",
  "subGraphForNode": {
    "refPath": "/Game/SHAR_MCP_Validation_PCG_c297c180/PCG_MCP_Sub_c297c180.PCG_MCP_Sub_c297c180"
  },
  "xPositionIdx": 1100,
  "yPositionIdx": 100
}
...
`GetGraphStructure` added the exact named Subgraph node that referenced the
disposable child graph.
...
- The child graph must remain valid for the lifetime of the subgraph node and
  should be deleted only after the parent graph.
