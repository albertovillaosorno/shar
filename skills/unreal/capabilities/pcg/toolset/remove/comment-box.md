...
Use this tool to remove one exact PCG editor comment box by its opaque
identifier.
...
A Slate snapshot showed the updated unique comment text disappear after
removal.
...
The unique id of the comment to remove.
...
Graph to remove the comment from.
