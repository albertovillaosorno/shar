...
Use this tool to assign reviewed explanatory text to a SHAR PCG graph.
...
```json
{
  "description": "Disposable SHAR PCG validation c297c180",
  "graph": {
...
`GetGraphDescription` changed from an empty string to the exact disposable
SHAR validation description.
