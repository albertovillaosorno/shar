...
Asset existence changed from false to true, and `GetGraphStructure` returned
the exact empty Dataflow graph identity.
...
Name for the new Dataflow asset (e.g., "DF_Simulation")
...
The full asset path of the created graph, or empty string on failure
