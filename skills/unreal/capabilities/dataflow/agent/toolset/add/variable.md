...
Supported type strings: Primitives : "Bool", "Int32", "Int64", "Float",
"Double", "Name", "String" Structs    : UScriptStruct name with or without the
"F" prefix e.g. "Vector", "FVector", "Transform", "FTransform", "Rotator",
"LinearColor" Objects    : "Object:&lt;ClassName&gt;" where ClassName is with
or without the "U"/"A" prefix e.g. "Object:StaticMesh", "Object:USkeletalMesh"
...
Use this tool to add one typed variable to a reviewed Dataflow graph.
...
`ListVariables` changed from an empty list to one Float variable named
`MCPValue`.
...
Unique name for the new variable
...
Type string as described above
...
true on success, false if the variable already exists or the type cannot be
resolved
