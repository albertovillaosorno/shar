...
Use this tool to enumerate transitions attached to one state for a
StateTreeState returned by the same editor-authored StateTree.
...
- Transition targets and conditions require separate interpretation from the
  returned structs.
