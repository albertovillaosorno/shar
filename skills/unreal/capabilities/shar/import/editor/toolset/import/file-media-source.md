...
```text
SharImportEditor.SharImportToolset.ImportFileMediaSource
```
...
Copies one verified HAP MOV into Content/Movies and creates its source. The
package remains dirty for explicit save by the plan transaction.
...
Absolute verified MOV source path.
...
The created FileMediaSource object path.
