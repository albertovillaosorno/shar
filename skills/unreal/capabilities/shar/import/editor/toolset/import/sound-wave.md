...
```text
SharImportEditor.SharImportToolset.ImportSoundWave
```
...
Imports one WAV file as a SoundWave under /Game/Generated/SHAR. The caller
...
Absolute verified WAV source path.
...
Object paths produced by the automated import task.
