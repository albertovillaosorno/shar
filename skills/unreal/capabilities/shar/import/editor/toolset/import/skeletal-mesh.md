...
PhysicsAsset and animation creation are disabled for this transaction. The
caller remains responsible for saving and postcondition read-back.
...
Exact destination SkeletalMesh asset name.
...
SkeletalMesh then Skeleton object paths owned by the transaction.
