...
Use this tool to add one typed member variable to a Control Rig Blueprint.
...
`get_variable` returned `MCPValue` as public C++ type `double` with default
value `3.500000` after an empty pre-state.
