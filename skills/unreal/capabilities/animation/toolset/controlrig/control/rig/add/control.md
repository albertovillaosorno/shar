...
Use this tool to add one animation control beneath an exact hierarchy parent.
...
`get_all_controls` added the exact `MCP_Control` hierarchy key beneath the
authored null.
