...
Use this tool to add the dedicated interaction model to a Control Rig
Blueprint.
...
`list_graphs` added the exact dedicated `RigVMModel MCPInteraction` model.
...
Optional custom name (default: "Interaction").
