...
Use this tool to create a blank disposable Control Rig asset before bounded
SHAR hierarchy and graph validation.
...
```json
{
  "path": "/Game/SHAR_MCP_Validation_ControlRig/CR_MCP"
}
```
...
Asset existence changed from false to true, and `get_elements` returned an
empty hierarchy for the exact new Control Rig Blueprint.
...
The content browser path for the new Control Rig.
