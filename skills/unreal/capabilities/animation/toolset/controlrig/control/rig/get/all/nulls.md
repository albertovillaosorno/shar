...
Use this tool to inventory null or locator hierarchy elements before SHAR
resolves parent chains and transforms.
...
- Keep null elements distinct from deprecated Space terminology.
...
Two disposable cycles returned exactly `AimNull`. `CRU_AddLocator` also provided
a real authored one-null positive fixture.
<!-- END MANUAL FIELD: project-verification -->

### Known project caveats

<!-- BEGIN MANUAL FIELD: known-caveats -->
- Results contain hierarchy keys only.
- Empty is valid for rigs without locators.
- Null names can overlap names from other element types.
