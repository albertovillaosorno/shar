...
Use this tool to add the dedicated backward-solve model to a Control Rig
Blueprint.
...
`list_graphs` added the exact dedicated `RigVMModel MCPBackward` model.
...
Optional custom name (default: "Backward Solve").
