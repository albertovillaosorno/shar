...
Use this tool to set one Control Rig world transform at an exact SHAR sequence
frame.
...
The dedicated world-transform getter returned location 21/22/23 and rotation
approximately 24/25/26 at frame 48.
...
- The tool accepts location and rotation only; it does not expose scale
  arguments.
- Rotation values showed small floating-point noise.
