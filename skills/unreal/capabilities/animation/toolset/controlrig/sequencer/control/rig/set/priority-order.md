...
Use this tool to set the evaluation priority of one exact SHAR Control Rig
track.
...
The call returned true and `get_priority_order` returned exactly 17.
...
The priority order value to set.
