...
Use this tool to key exact Control Rig controls at an explicit bounded list of
SHAR sequence frames.
...
The call returned true and `get_keys` returned exact FloatControl keys at
frames 60 and 72, both with value 8.5.
...
- Every requested frame received the same evaluated source value in this
  fixture. Re-read all generated keys rather than assuming per-frame
...
List of frame numbers at which to set keys.
