...
Use this tool to clear active Control Rig control selection before the next
deterministic SHAR editor operation.
...
The call returned true and `get_selected_controls` changed from an active
control selection to an empty list.
