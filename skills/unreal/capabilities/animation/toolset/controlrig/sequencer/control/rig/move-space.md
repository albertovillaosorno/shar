...
Use this tool to move one exact Control Rig space-switch key to a new frame.
...
The call returned true and the world-space key moved from frame 100 to frame
110 while the default frame 0 parent key remained.
...
The new frame to move the space key to.
...
The current frame of the space key.
