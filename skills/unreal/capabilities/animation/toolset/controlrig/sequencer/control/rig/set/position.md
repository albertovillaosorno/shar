...
Use this tool to set one Position Control Rig value at an exact SHAR sequence
frame.
...
The dedicated getter returned the exact 10/20/30 position for
`PositionControl` at frame 24.
