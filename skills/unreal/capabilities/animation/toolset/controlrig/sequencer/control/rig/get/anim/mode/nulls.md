...
Use this tool to read whether Animation Mode draws Control Rig nulls during
viewport inspection.
...
Two cycles returned `false` for null display.
<!-- END MANUAL FIELD: project-verification -->

### Known project caveats

<!-- BEGIN MANUAL FIELD: known-caveats -->
- This is global editor visualization state.
- Hidden null drawing does not remove null hierarchy elements.
- Rig-specific shape visibility remains separate.
- Re-read after Animation Mode changes.
