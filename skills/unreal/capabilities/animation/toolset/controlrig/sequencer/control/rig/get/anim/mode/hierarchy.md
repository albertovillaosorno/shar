...
Use this tool to read whether Animation Mode draws hierarchy lines and dots
during Control Rig viewport review.
...
Two cycles returned `false` for hierarchy drawing.
<!-- END MANUAL FIELD: project-verification -->

### Known project caveats

<!-- BEGIN MANUAL FIELD: known-caveats -->
- This is global editor state.
- It controls hierarchy visualization, not hierarchy data availability.
- A false value does not affect parent/child reads.
- Re-read after Animation Mode preference changes.
