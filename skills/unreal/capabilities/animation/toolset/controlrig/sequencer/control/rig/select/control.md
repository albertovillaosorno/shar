...
Use this tool to select or deselect one exact typed Control Rig control in the
open SHAR sequence.
...
Selecting `PositionControl` returned true and `get_selected_controls` returned
exactly that one control.
