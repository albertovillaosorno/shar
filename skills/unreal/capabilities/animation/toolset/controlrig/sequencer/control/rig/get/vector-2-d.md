...
Use this tool to verify a two-component Control Rig value such as planar offsets
or paired parameters at an exact Sequencer frame.
...
Two disposable cycles keyed Vector2Control to `(3.5, -4.25)` at frame 24 and
returned matching x and y fields.
...
- Validate the VECTOR2D type through `get_controls_info`.
- Do not treat zero components as proof of a valid control.
- Float serialization can preserve fractional precision noise.
