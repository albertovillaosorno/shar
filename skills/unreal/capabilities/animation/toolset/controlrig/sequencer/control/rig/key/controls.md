...
Use this tool to key exact Control Rig controls at the current SHAR Sequencer
playhead.
...
At playhead frame 84, the call returned true and `get_keys` added an exact
FloatControl key at frame 84 with evaluated value 8.5.
...
- The keyed value came from the evaluated Control Rig state at the playhead; a
  preceding non-keyed setter value was not captured.
