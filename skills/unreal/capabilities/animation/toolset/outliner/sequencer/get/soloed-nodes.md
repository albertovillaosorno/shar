...
Use this tool to list Sequencer Outliner nodes currently soloed.
...
- Interpret the result as editor-session state.
...
- Empty is valid when no nodes are soloed.
- Node proxies are live session objects, not durable identifiers.
- Outliner tree snapshots are not reusable proxies.
