...
Use this tool to list Outliner nodes deactivated in the active Sequencer editor.
...
- Treat deactivation as live editor state.
...
- Empty is valid.
- Returned live nodes can become stale after sequence edits.
- Tree snapshot dictionaries are presentation data only.
