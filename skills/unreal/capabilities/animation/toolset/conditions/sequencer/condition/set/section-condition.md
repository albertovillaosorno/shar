...
Use this tool to construct and assign one condition object to an exact
Sequencer section.
...
```json
{
  "condition_class": "/Script/MovieScene.MovieSceneCondition",
  "section": {
    "refPath": "/Game/SHAR_MCP_Validation_Round50_260718/LS_MCP_Round50.LS_MCP_Round50:MovieScene_0.MovieScene3DTransformTrack_4.MovieScene3DTransformSection_0"
  }
}
```
...
The call returned true and `get_section_condition` returned a newly
constructed `/Script/MovieScene.MovieSceneCondition` object.
...
Full class path of the condition type.
