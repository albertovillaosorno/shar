...
Use this tool to capture the current resolved actor state as the spawnable
template default.
...
The call returned true and custom-binding readers still resolved the expected
spawnable template and live actor class.
