...
Use this tool to convert one spawnable binding to a possessable and use the
returned identity.
...
The returned replacement binding reported no custom binding type and resolved
the converted live actor.
