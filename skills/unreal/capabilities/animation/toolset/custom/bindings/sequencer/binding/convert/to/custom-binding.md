...
Use this tool to convert one possessable binding to an exact native custom
binding class.
...
{
  "binding": {
    "bindingId": "94B08CA0-48D5-4620-43A6-6EADF7477A9D",
    "sequence": {
      "refPath": "/Game/SHAR_MCP_Validation_Round50_260718/LS_MCP_Round50.LS_MCP_Round50"
    }
  },
  "binding_type_class": "/Script/MovieSceneTracks.MovieSceneSpawnableActorBinding"
}
```
...
The returned binding reported
`/Script/MovieSceneTracks.MovieSceneSpawnableActorBinding` and resolved custom
template and live actor objects.
