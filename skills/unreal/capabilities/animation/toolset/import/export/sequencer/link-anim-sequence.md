...
When the sequence is modified, the linked AnimSequence can be automatically
updated.
...
True on success. Returns False (via the tool_call decorator) if sequence or
anim_sequence is None.
