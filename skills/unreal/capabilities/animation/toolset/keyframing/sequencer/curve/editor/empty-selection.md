...
Use this tool to clear Curve Editor key selection before the next
deterministic SHAR operation.
...
The call returned true and `get_curve_editor_selected_keys` returned an empty
list.
