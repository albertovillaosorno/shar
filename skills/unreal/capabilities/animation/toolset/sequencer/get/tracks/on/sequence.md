...
Use this tool to list sequence-level master tracks before SHAR inspects sections
or track-specific properties.
...
- Query binding tracks separately when object-bound tracks are required.
...
Two independent disposable empty-sequence cycles returned `[]`.
<!-- END MANUAL FIELD: project-verification -->

### Known project caveats

<!-- BEGIN MANUAL FIELD: known-caveats -->
- This returns sequence-level tracks only, not tracks owned by bindings.
- An empty list is valid for a new sequence.
- Returned track refs can become stale after structural edits.
