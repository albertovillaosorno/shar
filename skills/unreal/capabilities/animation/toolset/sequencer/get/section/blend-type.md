...
Use this tool to read the MovieScene blend mode applied by one section.
<!-- END MANUAL FIELD: project-use-cases -->

### Project prerequisites

<!-- BEGIN MANUAL FIELD: project-prerequisites -->
- Use an exact section ref from the target track.
- Preserve the full returned enum identity.
...
Two cycles returned `<MovieSceneBlendType.ABSOLUTE: 1>` for the Camera Cuts
section.
...
- Blend support varies by section class.
- Do not compare only the numeric suffix.
