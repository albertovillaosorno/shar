...
Use this tool to list every object binding authored in a LevelSequence before
SHAR inspects bound objects, tracks, or tags.
...
- Treat returned binding proxies as sequence-scoped identities.
...
- Binding proxies are sequence-scoped and can become stale after structural
  edits.
- This does not include sequence-level master tracks.
