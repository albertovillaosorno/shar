...
Use this tool to read MovieScene sections currently selected in the active
Sequencer editor.
...
- Read immediately after selecting sections.
...
Two cycles returned exactly the selected Camera Cuts section.
...
- Selecting another item category can clear section selection.
