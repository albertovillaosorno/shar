...
Use this tool to read root or nested MovieScene folders currently selected in
Sequencer.
...
- Read immediately after selecting folders.
...
Two cycles returned exactly the selected `SHARSelection` root folder.
...
- Selecting another category can clear folder selection.
- Folder refs become stale after deletion or sequence reconstruction.
