...
Use this tool to remove root folder during a bounded SHAR mission, dialogue,
...
{
  "folder": {
    "refPath": "/Game/SHAR_MCP_Validation_Replacement_2ce1ae2e/LS_MCP_Replacement_2ce1ae2e.LS_MCP_Replacement_2ce1ae2e:MovieScene_0.MovieSceneFolder_0"
  },
  "sequence": {
...
`get_root_folders` changed from 1 items to 0 items after the exact removal in
the disposable SHAR sequence. The removed identity no longer appeared in the
