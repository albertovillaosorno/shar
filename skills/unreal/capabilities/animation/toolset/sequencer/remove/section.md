...
Use this tool to remove section during a bounded SHAR mission, dialogue,
camera, or cinematic Level Sequence lifecycle.
...
{
  "section": {
    "refPath": "/Game/SHAR_MCP_Validation_Replacement_2ce1ae2e/LS_MCP_Replacement_2ce1ae2e.LS_MCP_Replacement_2ce1ae2e:MovieScene_0.MovieScene3DTransformTrack_2.MovieScene3DTransformSection_0"
  },
  "track": {
...
`get_sections` changed from 1 items to 0 items after the exact removal in the
disposable SHAR sequence. The removed identity no longer appeared in the
