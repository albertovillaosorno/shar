...
Use this tool to add a bounded repeating event section to a SHAR cinematic
event track before event payload authoring.
...
The returned repeater section reference appeared in `get_sections` for the
exact disposable event track.
