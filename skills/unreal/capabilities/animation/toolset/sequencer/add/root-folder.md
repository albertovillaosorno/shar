...
Use this tool to add root folder within a reviewed SHAR Level Sequence while
...
`get_root_folders` changed from 0 items to 1 items in the disposable SHAR
