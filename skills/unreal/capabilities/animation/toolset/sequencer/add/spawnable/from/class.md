...
Use this tool to add spawnable from class as a sequence-owned binding for SHAR
camera, staging, or scripted presentation work.
...
`get_bindings` changed from 2 items to 3 items in the disposable SHAR
...
Full class path, e.g. '/Script/Engine.CameraActor' or
