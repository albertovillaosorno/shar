...
Use this tool to add actors while authoring reviewed SHAR mission, dialogue,
camera, or cinematic actor bindings in Sequencer.
...
```json
{
  "actors": [
    {
      "refPath": "/Temp/Untitled_1.Untitled_1:PersistentLevel.Actor_UAID_00E04C68026718EF02_1425561112"
    }
  ]
}
```
...
The sequence binding inventory grew from zero to one binding.
`get_bound_objects` independently returned the exact temporary actor reference
...
List of Actors to bind into the sequence.
