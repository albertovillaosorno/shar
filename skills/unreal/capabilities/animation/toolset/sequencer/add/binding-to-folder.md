...
Use this tool to add binding to folder within a reviewed SHAR Level Sequence
...
In the disposable SHAR sequence, `get_folder_contents` changed from
{"track_count": 0, "binding_count": 0, "track_names": [],... to
{"track_count": 0, "binding_count": 1, "track_names": [],... after the call.
The result was read independently from the mutation response before cleanup.
