...
Use this tool to open sequence for a reviewed SHAR mission, dialogue, camera,
...
`get_current_sequence` changed from None to
LS_MCP_Batch50_555102d0.LS_MCP_Batch50_555102d0. The transition used the exact
disposable Level Sequence identity and was independently read after the call.
