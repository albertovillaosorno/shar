...
Use this tool to delete marked frame as a timing landmark in SHAR mission,
dialogue, camera, or cinematic sequences.
...
`get_marked_frames` changed from 2 items to 1 items in the disposable SHAR
...
Index of the marked frame to delete.
