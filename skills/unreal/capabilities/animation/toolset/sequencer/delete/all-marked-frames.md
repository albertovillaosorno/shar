...
Use this tool to delete all marked frames as a timing landmark in SHAR
mission, dialogue, camera, or cinematic sequences.
...
`get_marked_frames` changed from 1 items to 0 items in the disposable SHAR
