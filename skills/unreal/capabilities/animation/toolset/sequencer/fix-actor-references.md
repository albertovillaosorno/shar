...
Use this tool to repair resolvable actor bindings after SHAR sequence actors
or map identities change.
...
The call returned true and `get_bindings` preserved the same three binding
identifiers before and after the no-op repair pass.
