...
Use this tool to select sections in the focused Sequencer before a bounded
...
`get_selected_sections` changed from 0 items to 1 items in the disposable SHAR
