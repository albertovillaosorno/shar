...
Use this tool to select tracks in the focused Sequencer before a bounded SHAR
editor operation that depends on an exact selection.
...
`get_selected_tracks` changed from 0 items to 1 items in the disposable SHAR
