...
Use this tool to replace one possessable binding actor set with exact reviewed
actors.
...
The call returned true and `get_bound_objects` resolved only the exact
replacement actor.
