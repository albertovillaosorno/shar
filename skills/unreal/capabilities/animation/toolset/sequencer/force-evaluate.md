...
Use this tool to force an immediate SHAR sequence evaluation after key,
section, or binding changes.
...
The call returned true and `get_current_sequence` still reported the exact
disposable Level Sequence.
