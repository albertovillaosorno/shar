...
Use this tool to set track filter active within a reviewed SHAR Level Sequence
...
In the disposable SHAR sequence, `is_track_filter_active` changed from False
to True after the call. The result was read independently from the mutation
