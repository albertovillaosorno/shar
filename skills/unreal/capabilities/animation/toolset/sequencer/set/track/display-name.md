...
Use this tool to set track display name within a reviewed SHAR Level Sequence
...
In the disposable SHAR sequence, `get_track_display_name` changed from
Transform to MCP Transform after the call. The result was read independently
from the mutation response before cleanup.
