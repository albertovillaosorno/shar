...
Use this tool to set display rate for a reviewed SHAR mission, dialogue,
...
In the disposable SHAR sequence, `get_display_rate` changed from 30/1 to 24/1
...
Frame rate numerator (e.g. 30 for 30fps).
