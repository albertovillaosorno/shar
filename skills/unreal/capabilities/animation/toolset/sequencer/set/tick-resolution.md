...
Use this tool to set tick resolution for a reviewed SHAR mission, dialogue,
...
In the disposable SHAR sequence, `get_tick_resolution` changed from 24000/1 to
48000/1 after the call. The result was read independently from the mutation
