...
Use this tool to set selection range for a reviewed SHAR mission, dialogue,
...
In the disposable SHAR sequence, `get_selection_range` changed from {"start":
0, "end": 0} to {"start": 24, "end": 96} after the call. The result was read
