...
Use this tool to set section end bounded within a reviewed SHAR Level Sequence
...
In the disposable SHAR sequence, `has_section_end_frame` changed from True to
False after the call. The result was read independently from the mutation
...
True for bounded, False for infinite.
