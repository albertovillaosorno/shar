...
Post-roll continues evaluation after the section's real end, useful for
simulations that need to settle.
...
Use this tool to reserve deterministic post-roll frames for a SHAR cinematic
section.
...
The call returned true and `get_section_post_roll_frames` returned exactly 4.
...
Number of frames to post-roll (must be &gt;= 0).
