...
Use this tool to set section range within a reviewed SHAR Level Sequence while
...
In the disposable SHAR sequence, `get_section_range` changed from {"start": 0,
"end": 0} to {"start": 20, "end": 160} after the call. The result was read
