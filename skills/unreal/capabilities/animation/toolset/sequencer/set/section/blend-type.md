...
Use this tool to set section blend type within a reviewed SHAR Level Sequence
...
In the disposable SHAR sequence, `get_section_blend_type` changed from
<MovieSceneBlendType.ABSOLUTE: 1> to <MovieSceneBlendType.ADDITIVE: 2> after
the call. The result was read independently from the mutation response before
cleanup.
