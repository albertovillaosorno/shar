...
Use this tool to set section ease out within a reviewed SHAR Level Sequence
...
In the disposable SHAR sequence, `get_section_ease_out` changed from 0 to 10
