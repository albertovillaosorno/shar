...
Use this tool to control whether a SHAR section has an explicit lower frame
bound.
...
The start-frame getter changed from true to false after the call, then
returned to true during cleanup.
