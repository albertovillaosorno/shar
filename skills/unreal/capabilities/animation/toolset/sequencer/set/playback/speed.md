...
Use this tool to set playback speed for a reviewed SHAR mission, dialogue,
...
In the disposable SHAR sequence, `get_playback_speed` changed from 1 to 1.25
...
The speed multiplier (e.g. 1.0 for normal, 2.0 for double).
