...
Use this tool to lock a reviewed SHAR cinematic playback range against
accidental editor edits.
...
The playback-range getter changed from false to true after the call, then
returned to false during cleanup.
