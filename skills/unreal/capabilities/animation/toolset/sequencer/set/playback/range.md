...
Use this tool to set playback range for a reviewed SHAR mission, dialogue,
...
In the disposable SHAR sequence, `get_playback_range` changed from {"start":
0, "end": 120} to {"start": 12, "end": 240} after the call. The result was
read independently from the mutation response before cleanup.
