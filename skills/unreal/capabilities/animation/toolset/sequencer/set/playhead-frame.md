...
Use this tool to set playhead frame for a reviewed SHAR mission, dialogue,
...
In the disposable SHAR sequence, `get_playhead_frame` changed from 0 to 48
...
The frame number to move the playhead to.
