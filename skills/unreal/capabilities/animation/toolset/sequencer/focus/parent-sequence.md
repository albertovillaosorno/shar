...
Use this tool to return Sequencer focus from a sub-sequence to its parent
sequence.
...
The call returned true; `get_focused_sequence` returned the root sequence and
the sub-sequence hierarchy no longer reported nested focus.
