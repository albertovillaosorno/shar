...
If the tag has not been seen in the sequence before, it is automatically
registered.
...
Use this tool to tag binding within a reviewed SHAR Level Sequence while
...
`get_binding_tags` changed from 0 items to 1 items in the disposable SHAR
