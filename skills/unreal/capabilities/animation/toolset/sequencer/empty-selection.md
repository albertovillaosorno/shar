...
Use this tool to empty selection in the focused Sequencer before a bounded
...
In the disposable SHAR sequence, `all four selection readers` changed from
structured state to structured state after the call. The result was read
