...
Finds the world position of the nearest solid object at a given set of
normalized view space coords.
...
The normalized screen-space coordinates to trace from.
...
The maximum distance to trace within the scene.
...
The world-space coordinates of the intersection point.
