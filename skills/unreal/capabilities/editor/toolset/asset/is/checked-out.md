...
Use this tool to capture source-control checkout state before SHAR changes an
asset package. The verified BaseMaterial fixture was not checked out by the
current editor user.
...
- Query immediately before a source-control-sensitive mutation.
