...
Use this tool to check whether a SHAR asset package has unsaved changes before
comparison, validation, or an explicit save step. The verified engine-plugin
fixture was clean.
...
- Query after the relevant editor operation and before assuming persistence.
...
remained stable, and checkout state also returned `false`. A missing asset
raised
...
The path to the asset to check.
