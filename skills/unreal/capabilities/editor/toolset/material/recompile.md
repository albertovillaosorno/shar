...
deleting expressions, making connections, or changing expression properties
such as parameter names or default values.
...
Use this tool to recompile a SHAR material after graph or parameter edits
...
```json
{
  "material_or_function": {
    "refPath": "/Game/SHAR_MCP_Validation_SeqRound_260718/M_MCP_SeqRound_260718.M_MCP_SeqRound_260718"
  }
}
```
...
The call returned null without error; the child material instance then listed
the exact scalar, vector, texture, and static-switch parameters.
...
- The operation returns null. Verify downstream parameter discovery or another
  compiled consumer rather than treating transport completion as proof.
