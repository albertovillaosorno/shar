...
Use this tool to create one reusable SHAR material function asset in an
approved content folder.
...
Asset existence changed from false to true. The returned material-function
reference matched the requested package, and its expression inventory was
empty.
