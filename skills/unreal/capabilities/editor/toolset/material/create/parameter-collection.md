...
An MPC holds named Scalar and Vector parameters with default values that
materials can reference at runtime without recompiling shaders.
...
Use this tool to create one SHAR material parameter collection for reviewed
...
Asset existence changed from false to true, and the returned collection
reference matched the exact requested package and object identity.
