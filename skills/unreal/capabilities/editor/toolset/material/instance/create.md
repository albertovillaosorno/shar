...
Use this tool to create one SHAR Material Instance Constant with an exact
reviewed parent material.
...
Asset existence changed from false to true. ObjectTools returned the exact
parent material, and `list_parameters` returned scalar, vector, texture, and
