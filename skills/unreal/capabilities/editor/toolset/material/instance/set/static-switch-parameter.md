...
Use this tool to set one static-switch override used by a SHAR material
variant.
...
The static-switch getter returned true after the override was applied.
