...
Use this tool to assign one reviewed texture override to a SHAR material
variant.
...
```json
{
  ...
  "name": "MCPTexture",
  "value": {
    "refPath": "/Engine/EngineResources/WhiteSquareTexture.WhiteSquareTexture"
  }
}
```
...
The texture getter returned the exact engine `WhiteSquareTexture` reference.
