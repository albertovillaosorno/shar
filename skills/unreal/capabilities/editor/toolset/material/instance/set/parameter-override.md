...
Use this tool to enable or disable one named SHAR material-instance parameter
override.
...
Disabling the scalar override changed the getter from the overridden value to
the parent default 0.25.
