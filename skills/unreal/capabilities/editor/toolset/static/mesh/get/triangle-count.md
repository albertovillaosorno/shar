...
Use this tool to measure rendered triangle complexity for one validated static-
mesh LOD during SHAR import, optimization, or parity review.
...
Two LOD 0 calls returned `48`. Indices `-1`, `1`, and `999` each raised an out-
...
- The value describes render triangles for the requested LOD, not collision
  triangles.
- Reimport, reduction, or Nanite build changes can alter geometry counts.
- Always validate the LOD range first.
