...
Sections correspond to individual material slots rendered by a single draw
call. A mesh may have more sections than material slots if multiple sections
...
Use this tool to inspect rendered section count for one validated skeletal-mesh
LOD during SHAR material and draw-call review.
...
Two LOD 0 calls returned `1`. The mesh independently exposed one material slot.
Invalid indices `-1`, `1`, and `999` each raised an out-of-range error.
<!-- END MANUAL FIELD: project-verification -->

### Known project caveats

<!-- BEGIN MANUAL FIELD: known-caveats -->
- Sections are render sections, not skeleton bones or physics bodies.
- One slot can participate in one or more sections on other meshes.
- Reimport and LOD regeneration can change section counts.
