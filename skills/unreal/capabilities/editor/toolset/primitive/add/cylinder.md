...
Use this tool to add one cylinder-shaped SHAR scene component for bounded
trigger, route, collision-proxy, debug, or spatial-layout validation.
...
```json
{
  ...
  "name": "SHAR_MCP_ValidationCylinder",
  "radius": 30,
  "height": 140,
  "local_transform": {
...
`/Engine/BasicShapes/Cylinder.Cylinder`, local location approximately
`(0, -100, 0)`, yaw approximately `30`, and relative scale `(0.6, 0.6, 1.4)`.
Exact-reference removal returned `true`, and the actor's original component list
