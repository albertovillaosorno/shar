...
Use this tool to add one box-shaped SHAR scene component for bounded volume,
layout, collision-proxy, debug, or placement validation.
...
`/Engine/BasicShapes/Cube.Cube`, local location approximately `(0, 100, 0)`,
yaw approximately `20`, and relative scale `(0.8, 1, 1.2)`, matching the
requested 80 by 100 by 120 dimensions. Exact-reference removal returned `true`,
and the original component list was restored exactly.
