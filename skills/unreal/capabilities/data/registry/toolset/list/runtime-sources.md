...
Returns the runtime sources for a Data Registry. This is the expanded list
including transient child sources generated from meta sources. Will equal
ListDataSources when the registry has no meta sources.
...
Use this tool to enumerate runtime sources currently attached to a registry
before SHAR gameplay systems consume registry-backed data.
...
- Runtime source inventory is session state and can change after reload.
...
A list of source summaries, in runtime order.
