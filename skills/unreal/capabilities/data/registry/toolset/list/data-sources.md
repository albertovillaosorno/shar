...
Returns the editor-defined sources configured on a Data Registry. These are the
sources as authored on the registry asset, before any runtime expansion of meta
sources.
...
Use this tool to enumerate configured data sources for one registry before SHAR
...
- Configured sources can differ from currently active runtime sources.
...
A list of source summaries, in definition order.
