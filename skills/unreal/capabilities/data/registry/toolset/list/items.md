...
Use this tool to enumerate item names exposed by one active registry before SHAR
...
- Bound processing explicitly when a registry exposes many items.
...
All item names defined on the registry, in registry order.
