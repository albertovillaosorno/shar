...
#   - test_map_policy.py
# Path:
#   - uproject/tests/project_descriptor/test_map_policy.py
#
# Copyright:
...
GUIDE_IGNORE_RULE = "uproject/Content/SHAR/EditorOnly/StructuralGuide/"
WORLD_MAP_IGNORE_RULE = (
    f"!uproject/Content/SHAR/Maps/OpenWorld/{WORLD_NAME}.umap"
)
WORLD_ACTORS_IGNORE_RULE = (
    "!uproject/Content/__ExternalActors__/SHAR/Maps/OpenWorld/"
    f"{WORLD_NAME}/**/*.uasset"
)
WORLD_OBJECTS_IGNORE_RULE = (
    "!uproject/Content/__ExternalObjects__/SHAR/Maps/OpenWorld/"
    f"{WORLD_NAME}/**/*.uasset"
)
WORLD_LFS_RULE = (
    f"uproject/Content/SHAR/Maps/OpenWorld/{WORLD_NAME}.umap "
