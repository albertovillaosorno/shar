...
# Boundary-Contract:
# - Owns:
#   - Live native capability audit for compiled vehicle-material construction.
# - Must-Not:
...
# - Summary:
#   - Vehicle-material native capability auditor.
# - Description:
...
"""Live capability audit for compiled vehicle-material construction."""
...
class VehicleMaterialToolRequirement(NamedTuple):
...
class VehicleMaterialCapabilityReport(NamedTuple):
...
def audit_vehicle_material_capabilities(
    ...
    for requirement in requirements:
        ...
        try:
            ...
            if tool.output_schema is None:
                fail_protocol(
                    "vehicle-material native tool has no output schema"
                )
            validate_tool_arguments(
                tool.output_schema,
    ...
    return VehicleMaterialCapabilityReport(
        construction_revision=vehicle_material_construction_revision(compiled),
