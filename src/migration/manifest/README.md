...
cannot be confused with admission minima. Observation also requires at least
one countable structural row, so successful stdout is never an empty unusable
ledger.
