// File:
//   - validate.rs
// Path: src/migration/manifest/composition/bin/validate.rs
//
// Copyright:
...
// Boundary-Contract:
// - Owns:
//   - The minimal process entrypoint for minimum game-manifest validation.
// - Must-Not:
...
// - Summary:
//   - Thin `validate-game` process entrypoint.
// - Description:
//   - Keeps command behavior inside the driving CLI adapter.
// - Usage:
//   - Invoked by Cargo as the `validate-game` binary.
// - Defaults:
...
//! Thin process entrypoint for minimum game-manifest validation.
...
fn main() -> ExitCode {
    game_manifest::adapters::driving::validate_cli::run_env()
}
