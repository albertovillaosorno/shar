...
pub use application::{
    ...
    ObserveManifestReport, StructuralAudit, StructuralAuditReport,
    ValidateManifest, ValidateManifestReport,
};
pub use domain::{
    ...
    MANIFEST_FILE_NAME, NO_EXTENSION, classify_manifest_bucket,
    count_by_dir_ext_paths, exact_file_shortfalls, extension_of,
    kind_taxonomy_jsonl, obfuscate_component,
};
