...
pub fn schema_ref_for_kind(kind: &str) -> Option<&'static str> {
    Some(match kind {
        ...
        "scrooby_screen" => "scrooby_screen",
        "scrooby_page" => "scrooby_page",
        "scrooby_layer" => "scrooby_layer",
        "scrooby_image_resource" => "scrooby_image_resource",
        "scrooby_pure3d_resource" => "scrooby_pure3d_resource",
        "scrooby_text_style_resource" => "scrooby_text_style_resource",
        "scrooby_text_bible_resource" => "scrooby_text_bible_resource",
