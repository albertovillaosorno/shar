...
pub(super) fn name_class_node(
    ...
    BinaryNode::leaf(node_name, vec![name_class(name, class)])
}
...
pub(super) fn vector_property(name: &str, value: [f64; 3]) -> BinaryNode {
    property(
        ...
        name,
        "A",
        value.into_iter().map(BinaryProperty::F64).collect(),
    )
}
...
pub(super) fn xref_string_property(name: &str, value: &str) -> BinaryNode {
    property(name, "KString", "XRefUrl", vec![string(value)])
}
...
pub(super) fn layer_element(
    ...
    BinaryNode::branch("LayerElement", vec![
        ...
        i32_node("TypedIndex", typed_index),
    ])
}
...
pub(super) fn export_root_node() -> Result<BinaryNode, StructuralGuideFbxError>
{
    ...
    Ok(BinaryNode::new(
        ...
        vec![
            ...
            name_class("SHAR_Export_Root", "Model"),
            string("Null"),
        ],
        vec![
            ...
            BinaryNode::branch("Properties70", vec![
                ...
                vector_property("Lcl Translation", transform.translation),
                vector_property("Lcl Rotation", transform.rotation_degrees),
                vector_property("Lcl Scaling", transform.scale),
                property("Visibility", "Visibility", "A", vec![
...
pub(super) fn model_node() -> Result<BinaryNode, StructuralGuideFbxError> {
    Ok(BinaryNode::new(
        ...
        vec![
            ...
            name_class(STRUCTURAL_GUIDE_ASSET_NAME, "Model"),
            string("Mesh"),
        ],
        vec![
            i32_node("Version", 232),
            BinaryNode::branch("Properties70", vec![
                integer_property("DefaultAttributeIndex", 0),
                vector_property("Lcl Translation", [0., 0., 0.]),
                vector_property("Lcl Rotation", [0., 0., 0.]),
                vector_property("Lcl Scaling", [1., 1., 1.]),
                property("Visibility", "Visibility", "A", vec![
                    BinaryProperty::F64(1.),
                ]),
            ]),
...
pub(super) fn material_node() -> Result<BinaryNode, StructuralGuideFbxError> {
    Ok(BinaryNode::new(
        ...
        vec![
            ...
            name_class(STRUCTURAL_GUIDE_MATERIAL_NAME, "Material"),
            string(""),
        ],
        vec![
            i32_node("Version", 102),
            string_node("ShadingModel", "lambert"),
            i32_node("MultiLayer", 0),
            BinaryNode::branch("Properties70", vec![
                color_property("DiffuseColor", [1., 1., 1.]),
                color_property("AmbientColor", [0., 0., 0.]),
                color_property("EmissiveColor", [0., 0., 0.]),
                double_property("EmissiveFactor", 0.),
                double_property("TransparencyFactor", 0.),
            ]),
        ],
    ))
}
...
pub(super) fn texture_node() -> Result<BinaryNode, StructuralGuideFbxError> {
    Ok(BinaryNode::new(
        ...
        vec![
            ...
            name_class(STRUCTURAL_GUIDE_MATERIAL_NAME, "Texture"),
            string(""),
        ],
        vec![
            ...
            name_class_node("Media", STRUCTURAL_GUIDE_MATERIAL_NAME, "Video"),
            string_node("FileName", STRUCTURAL_GUIDE_TEXTURE_PATH),
            string_node("RelativeFilename", STRUCTURAL_GUIDE_TEXTURE_PATH),
            BinaryNode::branch("Properties70", vec![
                integer_property("CurrentTextureBlendMode", 1),
                double_property("TranslationU", 0.),
                double_property("TranslationV", 0.),
                double_property("ScalingU", 1.),
                double_property("ScalingV", 1.),
                integer_property("WrapModeU", 1),
                integer_property("WrapModeV", 1),
            ]),
        ],
    ))
}
...
pub(super) fn video_node() -> Result<BinaryNode, StructuralGuideFbxError> {
    Ok(BinaryNode::new(
        ...
        vec![
            ...
            name_class(STRUCTURAL_GUIDE_MATERIAL_NAME, "Video"),
            string("Clip"),
        ],
        vec![
            string_node("Type", "Clip"),
            BinaryNode::branch("Properties70", vec![
                xref_string_property("Path", STRUCTURAL_GUIDE_TEXTURE_PATH),
                xref_string_property("RelPath", STRUCTURAL_GUIDE_TEXTURE_PATH),
            ]),
