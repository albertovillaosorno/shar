...
// Path: src/formats/fbx/adapter-outbound/decoded_rigid_prop_source.rs
//
// Copyright:
...
fn append_instanced_binding(
    ...
    *ordinal = ordinal.saturating_add(1);
    ...
    state
        ...
        .push(
            SkinnedPart {
                group_influences: rigid_group_influences(
                    &mesh, &bone_id,
                )?,
                mesh,
            },
