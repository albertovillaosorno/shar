// File:
//   - report.rs
// Path: src/formats/fbx/application/report.rs
//
// Copyright:
...
// Boundary-Contract:
// - Owns:
//   - fbx use-case orchestration for application report.
// - Must-Not:
...
//   - invariant.
// - Summary:
//   - fbx application behavior for application report.
// - Description:
//   - Defines report data and behavior for fbx application.
// - Usage:
...
//! This application module coordinates application report without choosing
//! adapters.
