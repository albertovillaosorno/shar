...
functions, filesystem access, serde decoding, package-index reading, CLI parsing,
...
still pure domain work. The domain must not resolve the evidence itself. Evidence
