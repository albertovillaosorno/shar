...
// Path: tests/formats/rcf/source_text_integrity.rs
//
// Copyright:
...
// - Must-Not:
//   - Read private assets, generated outputs, or files outside RCF source and tests.
// - Allows:
//   - Deterministic reads of checked-in RCF source and external test files.
// - Split-When:
...
// - Defaults:
//   - Only explicitly listed repository-owned RCF test sources are scanned.
//
// ADRs:
