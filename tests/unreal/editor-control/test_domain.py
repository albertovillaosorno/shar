# File:
#   - test_domain.py
# Path: tests/unreal/editor-control/test_domain.py
#
# Copyright:
...
from mcp.domain.errors import EndpointValidationError, ProtocolError
...
def test_json_normalizer_rejects_excessive_container_items(
    ...
    monkeypatch.setattr(
        "mcp.domain.json_types._MAX_CONTAINER_ITEMS",
        2,
        raising=False,
    )
...
def test_json_rejects_excessive_key_bytes_before_context_copy(
    ...
    monkeypatch.setattr(
        "mcp.domain.json_types._MAX_JSON_KEY_BYTES",
        4,
        raising=False,
    )
...
def test_toolset_catalog_rejects_excessive_registry_entries(
    ...
    monkeypatch.setattr(
        "mcp.domain.catalog._MAX_TOOLSET_SUMMARIES",
        2,
        raising=False,
    )
...
def test_toolset_catalog_rejects_excessive_description_bytes(
    ...
    monkeypatch.setattr(
        "mcp.domain.catalog._MAX_DESCRIPTION_BYTES",
        4,
        raising=False,
    )
...
def test_toolset_schema_rejects_excessive_tools(
    ...
    monkeypatch.setattr(
        "mcp.domain.catalog._MAX_TOOLS_PER_TOOLSET",
        2,
        raising=False,
    )
    schema: JsonObject = {
