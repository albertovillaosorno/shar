...
def test_initialize_rejects_excessive_session_id_length(
    ...
    monkeypatch.setattr(
        "mcp.adapter_outbound.response_validation._MAX_SESSION_ID_LENGTH",
        4,
        raising=False,
    )
...
def test_initialize_rejects_excessive_server_metadata_length(
    ...
    monkeypatch.setattr(
        "mcp.adapter_outbound.response_validation._MAX_SERVER_METADATA_LENGTH",
        4,
        raising=False,
    )
...
def test_tool_names_reject_excessive_identity_bytes(
    ...
    monkeypatch.setattr(
        "mcp.adapter_outbound.response_validation._MAX_TOOL_NAME_BYTES",
        4,
        raising=False,
    )
...
def test_tool_names_reject_excessive_page_entries(
    ...
    monkeypatch.setattr(
        "mcp.adapter_outbound.response_validation._MAX_TOOLS_PER_PAGE",
        2,
        raising=False,
    )
    result: JsonObject = {
