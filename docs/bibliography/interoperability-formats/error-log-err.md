...
- Evidence status: Partially verified — UTF-8 ERR normalization and structured
  diagnostic summaries are verified in the pipeline; the originating producer,
  grammar, diagnostic taxonomy, version history, and rights authority remain
  unresolved.
- Counsel review: Not performed.
- Jurisdictional scope: Not determined.
- As-of date: 2026-07-13.
- Distribution posture: Local interoperability research only.
- Subject class: Proprietary or tool-generated diagnostic text format.

## Covered Material

ERR files normalized by the straggler pipeline, including severity-like tokens,
line structure, source ordering, and bounded diagnostic summaries.

## Repository Use And Scope

The pipeline reads valid UTF-8 ERR files and emits structured JSON summaries. It
does not execute their contents or assume that every ERR file shares one
producer or grammar.

## Provenance And Version History

Repository evidence confirms ERR files in the game or toolchain surface, but the
originating tool, authoritative grammar, version history, diagnostic taxonomy,
and rights authority remain unresolved.
...
- Do not infer ownership, authorization, or redistribution rights from
  successful decoding.
- Treat logs as potentially containing paths, identifiers, or confidential
  operational data.
- Do not publish full diagnostic bodies until provenance, privacy, and third-
  party content are reviewed.
...
- Historical Radical source notices reviewed locally; source material not
  distributed.
- SHAR repository (2026) pipeline error-log decoder and tests.
