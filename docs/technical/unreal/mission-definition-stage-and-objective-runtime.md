...
sibling with the longest matching level-load family, keyed by the full source
path so identical mission ids in different levels stay isolated. The initial
