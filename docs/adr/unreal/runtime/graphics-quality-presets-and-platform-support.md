...
The native audio engine owns playback, source voices, decoding, stream caching,
Audio Components, attenuation, spatialization, concurrency, routing, mixing,
virtualization, effects, device output, and platform backends. Presets may
change
codecs, sample rates, optional layers, MetaSound complexity, residency and
stream-
cache budgets, Sound Class loading behavior, native quality levels, source and
stopping-voice limits, decoder pressure, submix effect cost, Audio Volume
processing, occlusion, reverb, and spatialization implementations.

They cannot replace the Audio Mixer with a preset-specific renderer, recreate
fixed clip or stream player arrays, remove required dialogue, music, sequence
audio, or gameplay cues; change deterministic selection; alter subtitles;
reassign listener ownership; leak local-player audio; silently evict protected
